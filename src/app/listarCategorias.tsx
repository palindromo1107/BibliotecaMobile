...
const listarCategorias = () => {
    ...
    const [categorias, setcategorias] = useState([
        ...
        },
        {
            id: 6,
            nome: "Infantil",
            descricao: "Livros destinados ao público infantil, com linguagem e histórias acessíveis"
        },
        {
            id: 7,
            nome: "Distopia",
    ...
    return (
        <View style={styles.container}>
            ...
            <Button title="Adicionar" onPress={handleShow}></Button>
            ...
            <View style={styles.tabela}>
                <View style={styles.tabelaHead}>
                    ...
                    <View style={styles.celula}>
                        <Text style={styles.textoCabecalho}>descricao</Text>
                    </View>
                </View>
